 ...
 * @param args the arguments, last argument will be removed from this array if is null or is transaction
...
exports.getTransaction = function(args) {
	...
	if (transaction == null) {
		// skip the null value
	} else if (exports.isTransaction(transaction)) {
 ...
 */
exports.isTransaction = function isTransaction(transaction) {
